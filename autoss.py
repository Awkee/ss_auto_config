...
def get_parser():
	...
	parser.add_argument("ss_qrcode_url", nargs = '?' , default = 'https://en.ss8.fun/images/server02.png', help = 'shadowsocks qrcode png image url, eg. http://ss.ishadowx.com/img/qr/jpaxxoo.png . choices:[us|sg|jp][abc], https://en.ss8.fun/images/server01.png , https://en.ss8.fun/images/server02.png , https://en.ss8.fun/images/server03.png , ss://xxxdfadfdkdflkdfldafkdd ' )
